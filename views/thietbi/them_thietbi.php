...
<div class="flex flex-col items-start justify-between w-full gap-4 my-6 sm:flex-row sm:items-center">
    <div>
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
            Đăng ký thiết bị phần cứng mới vào hệ thống quản lý IoT
        </p>
    </div>
...
<form action="index.php?page=thietbi_xuly_them" method="POST" id="deviceForm">
    ...
    <div class="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
        ...
        <button type="submit" 
            ...
            <i class="fas fa-plus-circle mr-2"></i> Lưu thiết bị mới
        </button>
    </div>
</form>
