...
// Giả định biến $data chứa thông tin thiết bị đã được lấy từ database ở Controller
?>
...
<div class="flex flex-col items-start justify-between w-full gap-4 my-6 sm:flex-row sm:items-center">
    ...
    <a href="index.php?page=thietbi&tab=thietbi" 
...
<form action="index.php?page=thietbi_xuly_sua" method="POST" id="deviceForm">
    
    <?php include 'thietbi_chung/thietbi_info.php'; ?>
...
<script>
    // Nhúng file JS bắt lỗi realtime
    <?php include 'thietbi_chung/thietbi_validate.js'; ?>
</script>
