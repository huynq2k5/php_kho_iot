...
<div class="flex flex-col items-start justify-between w-full gap-4 my-6 sm:flex-row sm:items-center">
    <div>
        <h2 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">
            Sửa khu vực: <span class="text-red-600 font-mono"><?= htmlspecialchars($data['maKhuVuc'] ?? '') ?></span>
        </h2>
      
    </div>
    
    <a href="index.php?page=thietbi&tab=khuvuc" 
...
<form action="index.php?page=khuvuc_xuly_sua" method="POST" id="zoneForm">
    
    <?php include 'khuvuc_chung/khuvuc_info.php'; ?>
    ...
    <div class="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
        ...
        <button type="submit" 
            ...
            <i class="fas fa-save mr-2"></i> Cập nhật khu vực
        </button>
    </div>
</form>

<script>
    <?php include 'khuvuc_chung/khuvuc_validate.js'; ?>
</script>
