...
<div class="grid gap-6 mb-8 md:grid-cols-12">
    ...
    <div class="md:col-span-7 space-y-6">
        ...
        <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
            <h4 class="mb-4 font-semibold text-gray-800 dark:text-gray-300 border-b pb-2 dark:border-gray-700 flex items-center">
                <i class="fas fa-user-edit mr-2 text-red-600"></i> Thông tin cơ bản
            </h4>
            <form action="index.php?page=profile_update_info" method="POST" class="space-y-4">
                <label class="block text-sm">
                    ...
                    <input class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-input focus:border-red-400 focus:shadow-outline-red" 
                           name="hoTen" value="<?= htmlspecialchars($user->hoTen ?? '') ?>" required>
                </label>
        ...
        <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
            <h4 class="mb-4 font-semibold text-gray-800 dark:text-gray-300 border-b pb-2 dark:border-gray-700 flex items-center">
                <i class="fas fa-lock mr-2 text-red-600"></i> Đổi mật khẩu
            </h4>
            <form action="index.php?page=profile_change_password" method="POST" class="space-y-4">
                <label class="block text-sm">
                    ...
                    <input type="password" name="old_password" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-input focus:border-red-400 focus:shadow-outline-red" required>
                </label>
                <div class="grid grid-cols-2 gap-4">
                    <label class="block text-sm">
                        <span class="text-gray-700 dark:text-gray-400">Mật khẩu mới</span>
                        <input type="password" name="new_password" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-input focus:border-red-400 focus:shadow-outline-red" required>
                    </label>
                    <label class="block text-sm">
                        <span class="text-gray-700 dark:text-gray-400">Xác nhận mật khẩu mới</span>
                        <input type="password" name="confirm_password" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-input focus:border-red-400 focus:shadow-outline-red" required>
                    </label>
                </div>
                <div class="flex justify-end mt-4">
    ...
    <div class="md:col-span-5 space-y-6">
        ...
        <div class="min-w-0 p-6 bg-gradient-to-br from-red-600 to-red-800 rounded-lg shadow-xs text-white">
            <div class="flex items-center justify-center w-16 h-16 mb-4 bg-white rounded-full text-red-600 text-2xl font-bold mx-auto shadow-inner overflow-hidden">
            ...
            <div class="text-center">
                ...
                <p class="text-red-200 font-mono text-sm mb-3">Mã: <?= htmlspecialchars($user->maNguoiDung ?? '') ?></p>
                <span class="px-3 py-1 bg-white bg-opacity-20 rounded-full text-sm font-semibold border border-red-400 backdrop-blur-sm">
        ...
        <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
            <h4 class="mb-4 font-semibold text-gray-800 dark:text-gray-300 border-b pb-2 dark:border-gray-700 flex items-center">
                <i class="fas fa-key mr-2 text-red-600"></i> Phân quyền chi tiết
            </h4>
