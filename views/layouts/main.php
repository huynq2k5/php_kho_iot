        ...
        tailwind.config = {
            ...
            theme: {
                extend: {
                    ...
                    boxShadow: {
                        'outline-red': '0 0 0 3px rgba(220, 38, 38, 0.45)', 
...
<body class="bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-gray-200">
    <!-- THÊM dark:bg-gray-900 dark:text-gray-200 cho body -->
    
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" 
         :class="{ 'overflow-hidden': isSideMenuOpen }">
        <!-- THÊM dark:bg-gray-900 cho div chính -->
