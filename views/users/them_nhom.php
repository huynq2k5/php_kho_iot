    ...
    <form action="index.php?page=nhom_xulythem" method="POST">
                    ...
                    <div class="space-y-4">
                        <label class="block text-sm">
                            ...
                            <input type="text" 
                                id="groupCode" 
                                name="group_code" 
                                class="block w-full mt-1 text-sm dark:bg-gray-700 dark:text-gray-300 form-input focus:border-red-400 focus:shadow-outline-red dark:focus:shadow-outline-gray font-mono uppercase" 
                                placeholder="VD: KE_TOAN_KHO" 
                                required 
                                maxlength="20">
                            <span class="text-xs text-red-600 dark:text-red-400 hidden mt-1" id="groupCode_error">Mã nhóm không hợp lệ</span>
                            <span class="text-xs text-gray-500 dark:text-gray-400 mt-1" id="groupCode_helper">Mã nhóm duy nhất, không dấu, không cách, viết hoa</span>
                        </label>

                        <!-- Trường Tên nhóm (đã có) - THÊM ID VÀ SPAN LỖI -->
                        <label class="block text-sm">
                        ...
                        <label class="block text-sm">
                            ...
                            <textarea class="block w-full mt-1 text-sm dark:bg-gray-700 dark:text-gray-300 form-textarea focus:border-red-400 focus:shadow-outline-red dark:focus:shadow-outline-gray" 
                                      name="description" 
                                      rows="3" 
                                      placeholder="Mô tả chi tiết về quyền hạn và trách nhiệm của nhóm này..."></textarea>
                        </label>
                    </div>
                </div>
            </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <!-- Radio buttons dạng grid -->
                                <div class="relative">
                                    <input type="radio" class="sr-only peer" name="badge_color" id="color_primary" value="blue" checked onchange="updatePreview()">
                                ...
                                <div class="relative">
                                    <input type="radio" class="sr-only peer" name="badge_color" id="color_success" value="green" onchange="updatePreview()">
                                ...
                                <div class="relative">
                                    <input type="radio" class="sr-only peer" name="badge_color" id="color_warning" value="yellow" onchange="updatePreview()">
                                ...
                                <div class="relative">
                                    <input type="radio" class="sr-only peer" name="badge_color" id="color_danger" value="red" onchange="updatePreview()">
                                ...
                                <div class="relative">
                                    <input type="radio" class="sr-only peer" name="badge_color" id="color_info" value="cyan" onchange="updatePreview()">
                                ...
                                <div class="relative">
                                    <input type="radio" class="sr-only peer" name="badge_color" id="color_dark" value="gray" onchange="updatePreview()">
                        ...
                        <div class="p-4 mt-2 bg-gray-50 rounded-lg border-2 border-dashed border-gray-200 dark:bg-gray-700 dark:border-gray-600 text-center">
                            ...
                            <span id="badgePreview" class="inline-flex items-center px-3 py-2 text-sm font-semibold rounded-full shadow-sm transition-all duration-300 bg-blue-100 text-blue-700 border border-blue-200 dark:bg-blue-900 dark:text-blue-300 dark:border-blue-800">
        ...
        <div class="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            ...
            <button type="submit" 
                ...
                <i class="fas fa-save mr-2"></i> Lưu & Tạo nhóm
            </button>
        </div>
    </form>
