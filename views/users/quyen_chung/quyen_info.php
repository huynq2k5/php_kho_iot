            ...
            <div class="space-y-4">
                    ...
                    <div class="relative mt-1">
                        ...
                        <?php if (isset($isEdit) && $isEdit === true): ?>
                            <input type="text" 
                                   ...
                                   disabled readonly>
                            <input type="hidden" name="permission_key" value="<?= $permission['maQuyen'] ?>">
                        <?php else: ?>
                            <input type="text" 
                                   id="permissionKey"
                                   name="permission_key" 
                ...
                <label class="block text-sm">
                    ...
                    <input type="text" 
                           ...
                           value="<?= (isset($isEdit) && $isEdit === true) ? $permission['tenQuyen'] : '' ?>"
                ...
                <label class="block text-sm">
                    ...
                    <textarea id="description" name="description" rows="3" 
                              class="block w-full mt-1 text-sm dark:bg-gray-700 dark:text-gray-300 form-textarea focus:border-red-400 focus:shadow-outline-red" 
                              placeholder="Mô tả chức năng này làm gì..."><?= (isset($isEdit) && $isEdit === true) ? $permission['moTa'] : '' ?></textarea>
                </label>
            </div>
        </div>
    </div>
